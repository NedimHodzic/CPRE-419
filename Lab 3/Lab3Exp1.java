...
public class Lab3Exp1 {
	...
	public static void main(String[] args) throws Exception {
		...
		String temp = "/labs/lab3/exp1/temp";
		...
		// is neccesary for integer Lab3Exp1.  
		...
		InputSampler.Sampler<IntWritable, Text> sampler = new InputSampler.RandomSampler<IntWritable, Text>(.1, 10000, 10);
